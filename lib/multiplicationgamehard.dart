...
class MultiplicationHardPage extends StatefulWidget {
  @override
  _AdditionPageState createState() => _AdditionPageState();
}

class _AdditionPageState extends State<MultiplicationHardPage> {
  int _score = 0;
  int _wrongAnswers = 0;
          ...
          return Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/images/multiplication_game_bg.jpg"),
                fit: BoxFit.cover,
              ),
            ),
            child: Padding(
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                  backgroundColor: Color(0xFF6f7f00)),
                            ),
                          ),
                          SizedBox(
                            width: 10,
